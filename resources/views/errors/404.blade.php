...
<div class="max-w-md mx-auto my-20 text-center px-4">
    <div class="space-y-6">
        <h1 class="text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-amber-500">404</h1>
        <h2 class="text-2xl font-bold text-white">Halaman Tidak Ditemukan</h2>
        <p class="text-slate-400">Maaf, halaman yang Anda cari tidak ditemukan atau telah dipindahkan.</p>
        <div class="pt-4">
